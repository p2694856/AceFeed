import { AppBskyEmbedRecord, AppBskyEmbedRecordWithMedia, AppBskyLabelerDefs, ComAtprotoLabelDefs } from '@atproto/api/dist/client';
import { InterpretedLabelValueDefinition } from '@atproto/api/dist/moderation/types';

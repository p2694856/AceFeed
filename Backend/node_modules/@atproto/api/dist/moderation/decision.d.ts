import { AppBskyGraphDefs } from '@atproto/api/dist/client';
import { MuteWordMatch } from '@atproto/api/dist/moderation/mutewords';
import { Label, LabelPreference, LabelTarget, ModerationBehavior, ModerationCause, ModerationOpts } from '@atproto/api/dist/moderation/types';
import { ModerationUI } from '@atproto/api/dist/moderation/ui';
export declare class ModerationDecision {
    ...
    get blockCause(): {
        type: "blocking";
        source: import("@atproto/api/dist/moderation/types").ModerationCauseSource;
        priority: 3;
        downgraded?: boolean;
    } | {
        type: "blocked-by";
    ...
    get labelCauses(): {
        ...
        source: import("@atproto/api/dist/moderation/types").ModerationCauseSource;
        label: Label;
        labelDef: import("@atproto/api/dist/moderation/types").InterpretedLabelValueDefinition;
        target: LabelTarget;

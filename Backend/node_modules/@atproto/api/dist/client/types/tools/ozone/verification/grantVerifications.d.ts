...
import type * as ToolsOzoneVerificationDefs from '@atproto/api/dist/client/types/tools/ozone/verification/defs.js';
...
export declare function isVerificationInput<V>(v: V): v is import("@atproto/api/dist/client/util.js").$TypedObject<V, "tools.ozone.verification.grantVerifications", "verificationInput">;
...
export declare function isGrantError<V>(v: V): v is import("@atproto/api/dist/client/util.js").$TypedObject<V, "tools.ozone.verification.grantVerifications", "grantError">;

...
export declare function isRevokeError<V>(v: V): v is import("@atproto/api/dist/client/util").$TypedObject<V, "tools.ozone.verification.revokeVerifications", "revokeError">;

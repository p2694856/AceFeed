...
export declare function isVerificationView<V>(v: V): v is import("@atproto/api/dist/client/util").$TypedObject<V, "tools.ozone.verification.defs", "verificationView">;

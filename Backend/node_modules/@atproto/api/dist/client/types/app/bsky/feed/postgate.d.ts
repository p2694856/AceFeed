...
export declare function isRecord<V>(v: V): v is import("@atproto/api/dist/client/util").$TypedObject<V, "app.bsky.feed.postgate", "main">;
export declare function validateRecord<V>(v: V): ValidationResult<Record & V>;
/** Disables embedding of this post. */
export interface DisableRule {
    $type?: 'app.bsky.feed.postgate#disableRule';
}
export declare function isDisableRule<V>(v: V): v is import("@atproto/api/dist/client/util").$TypedObject<V, "app.bsky.feed.postgate", "disableRule">;

...
import type * as AppBskyUnspeccedDefs from '@atproto/api/dist/client/types/app/bsky/unspecced/defs';
...
export declare function isThreadItem<V>(v: V): v is import("@atproto/api/dist/client/util").$TypedObject<V, "app.bsky.unspecced.getPostThreadV2", "threadItem">;

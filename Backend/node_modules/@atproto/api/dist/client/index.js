...
class AppBskyUnspeccedNS {
    ...
    initAgeAssurance(data, opts) {
        return this._client.call('app.bsky.unspecced.initAgeAssurance', opts?.qp, data, opts);
    }

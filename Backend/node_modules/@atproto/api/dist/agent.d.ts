...
import { AppBskyActorDefs, AppBskyActorProfile, AppBskyFeedPost, AppNS, ChatNS, ComNS, ToolsNS } from '@atproto/api/dist/client';
import { MutedWord, Nux } from '@atproto/api/dist/client/types/app/bsky/actor/defs';
import { Un$Typed } from '@atproto/api/dist/client/util';
import { InterpretedLabelValueDefinition, LabelPreference, ModerationPrefs } from '@atproto/api/dist/moderation/types';
import { SessionManager } from '@atproto/api/dist/session-manager';
import { AtpAgentGlobalOpts, AtprotoServiceType, BskyFeedViewPreference, BskyInterestsPreference, BskyPreferences, BskyThreadViewPreference } from '@atproto/api/dist/types';
import { Did } from '@atproto/api/dist/util';
...
export declare class Agent extends XrpcClient {
    ...
    mute(actor: string): Promise<import("@atproto/api/dist/client/types/app/bsky/graph/muteActor").Response>;
    unmute(actor: string): Promise<import("@atproto/api/dist/client/types/app/bsky/graph/unmuteActor").Response>;
    muteModList(uri: string): Promise<import("@atproto/api/dist/client/types/app/bsky/graph/muteActorList").Response>;
    unmuteModList(uri: string): Promise<import("@atproto/api/dist/client/types/app/bsky/graph/unmuteActorList").Response>;
    blockModList(uri: string): Promise<{
        uri: string;
        cid: string;
    }>;
    unblockModList(uri: string): Promise<void>;
    updateSeenNotifications(seenAt?: string): Promise<import("@atproto/api/dist/client/types/app/bsky/notification/updateSeen").Response>;

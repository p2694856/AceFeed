...
import { CallOptions, QueryParams } from '@atproto/xrpc/dist/types';
import { XrpcClient } from '@atproto/xrpc/dist/xrpc-client';
...
export declare class Client {
    ...
    set fetch(_: never);
    lex: Lexicons;
    call(serviceUri: string | URL, methodNsid: string, params?: QueryParams, data?: BodyInit | null, opts?: CallOptions): Promise<import("@atproto/xrpc/dist/types").XRPCResponse>;
